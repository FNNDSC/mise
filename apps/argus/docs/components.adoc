...
Status: on stage in the browser (2026-09-07, S2) and the runs roster (2026-09-08, S3); PACS (S4) still composes its listing by hand. The browser was the first pane converted, and its conversion is what turned this section from a declaration into a description of a thing that runs.
