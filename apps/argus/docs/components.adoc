...
| framed | `.listing-framed` on the mount | A declared `rowZone`. The indicated row is drawn as a segment of the frame — the frame's block colour, black type, reaching the spine — and the zone wears `.listing-zone`.
