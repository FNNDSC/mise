...
Status: on stage in the browser since 2026-09-07 (epic #428, S2); the roster (S3) and PACS (S4) still compose their listings by hand. The browser was the first pane converted, and its conversion is what turned this section from a declaration into a description of a thing that runs.
