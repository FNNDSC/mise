...
| facts | `.universe-facts` (a `.dag-facts`) | Inside a feed, the indicated node's payload — PLUGIN, INSTANCE, STATUS, COUNT on a fan, DATA — and its verbs, ENTER NODE and PROCESS, as `.universe-node-verbs`; hidden until a node is indicated.
