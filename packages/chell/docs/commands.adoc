...
ChELL supports glob-style wildcard patterns for applicable commands, including
`ls`, `rm`, and `cat`. Wildcards are expanded against the current ChRIS
directory, including virtual directories such as `/bin`.
