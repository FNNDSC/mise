...
The option establishes a future attachment point for a pipeline or individual plugin while keeping
feed creation itself explicit. Pipeline/plugin attachment is not part of the current command.
