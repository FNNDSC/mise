...
`--new-feed` is deliberately the operation that creates the analysis context. It may
optionally attach exactly one plugin or one registered pipeline to the newly created
`pl-dircopy` root:
