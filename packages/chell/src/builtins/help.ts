...
export const helpText: Record<string, CommandHelp> = {
  ...
  feeds: {
    ...
    options: [
      ...
      '',
      'SUBCOMMANDS:',
      '  list              List feeds (default: 20 per page)',
      '  fieldslist        List available feed fields',
      '  delete <id>       Remove a feed',
      '  share <id>        Share a feed with other users',
      '',
      'LIST OPTIONS:',
      '  --all             Fetch all feeds across all pages',
      '  --limit <n>       Return at most n feeds (default: 20)',
    ],
    examples: [
      '# List feeds (first page)',
      'feeds list',
      '# List all feeds regardless of count',
      'feeds list --all',
