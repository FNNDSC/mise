...
**Example path:**
```
/SERVICES/PACS/PACSDCM/7654321-DOE-19700101/PET_CH_DIAG_PETCT_TORSO_Over_55KG_Adult_-AccessionNumber-20240101/00005-AC_CT_DIAG_DIAG-98d76c0/0168-1.2.3.4.5.6.7.8.9.dcm
```
...
# Test PACS file
chell -c 'cat /SERVICES/PACS/PACSDCM/7654321-DOE-19700101/.../file.dcm'
